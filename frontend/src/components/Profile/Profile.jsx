...
const SkillItem = ({ skill, onRemove }) => (
  <div className="skill-tag">
    {skill} <X id="close" onClick={() => onRemove(skill)} />
  </div>
);
    ...
    const fetchProfile = async () => {
      try {
        const response = await fetch(
          `http://localhost:8000/api/users/${loggedInUser._id || loggedInUser.id}`,
        );
      ...
      <div className="profile-container">
        ...
        <section className="profile-section">
          ...
          <form
            ...
            className="add-item-form vertical"
          >
            ...
            <button type="submit" className="save-account-btn">
        ...
        <section className="profile-section">
          ...
          <div className="add-item-form vertical">
            ...
            <input
              ...
              onChange={(e) =>
                setNewEdu({ ...newEdu, graduationYear: e.target.value })
              }
            />
        ...
        <div className="profile-footer-links">
          ...
          <div className="footer-link-group">
            <Link to="/my-applications" className="btn-footer">
              Jobs I've Applied To
            </Link>
            <Link to="/my-postings" className="btn-footer secondary">
              My Job Postings
            </Link>
            <Link to="/create-job" className="btn-footer accent">
              Post a New Job
            </Link>
          </div>
        </div>
