...
import { UserPlus as UserPlusIcon, User as UserIcon, Mail as MailIcon, Lock as LockIcon, Camera as CameraIcon, ArrowRight as ArrowRightIcon, AlertCircle as AlertCircleIcon, CheckCircle2 as CheckCircle2Icon } from "lucide-react";
...
function Register() {
  ...
  return (
    <div className="min-h-screen bg-brand-background flex flex-col">
          ...
          <div className="p-8 md:p-12">
            <div className="text-center mb-10">
              <div className="w-16 h-16 bg-brand-accent-light rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-inner">
                <UserPlusIcon size={32} className="text-brand-primary" />
              </div>
            ...
            {message && (
              <div className={`mb-8 p-4 rounded-2xl flex items-center gap-3 text-sm font-medium border animate-in slide-in-from-top-2 ${
                ...
                {message.includes("successful") ? <CheckCircle2Icon size={18} /> : <AlertCircleIcon size={18} />}
                <span>{message}</span>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <UserIcon className="absolute left-4 top-1/2 -translate-y-1/2 text-brand-secondary/40" size={20} />
                    <input
                      type="text"
                      name="username"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <MailIcon className="absolute left-4 top-1/2 -translate-y-1/2 text-brand-secondary/40" size={20} />
                    <input
                      type="email"
                      name="email"
                      autoComplete="email"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <LockIcon className="absolute left-4 top-1/2 -translate-y-1/2 text-brand-secondary/40" size={20} />
                    <input
                      type="password"
                      name="new-password"
              ...
              >
                {loading ? "Creating Account..." : "Get A Job!"}
      ...
      {/* PFP Modal - Custom Implementation */}
      {showPopup && (
            ...
            <div className="text-center">
                ...
                <div className="relative w-32 h-32 mx-auto mb-8 bg-brand-background rounded-3xl overflow-hidden border border-brand-secondary/10">
                    ...
                    <label className="absolute inset-0 flex items-center justify-center cursor-pointer bg-brand-primary/0 hover:bg-brand-primary/20 transition-colors group">
                        ...
                        <CameraIcon size={24} className="text-brand-surface opacity-0 group-hover:opacity-100 transition-opacity" />
                    </label>
                </div>
